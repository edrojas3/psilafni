...
# try with anticor with a ventricle mask insted of a csf mask
# -------------------------------------------------
...
# SET VARIABLES
set sub	      = sub-032135
set outdir    =  /mnt/MD1200B/egarza/afajardo/primeDE/site-ucdavis/data_ap/${sub}_anaticor_vent
set cost_func = mi
...
afni_proc.py \
	...
	-regress_ROI_PC VENT_Mask 3 \
	-regress_ROI_PC_per_run WM_Mask VENT_Mask \
