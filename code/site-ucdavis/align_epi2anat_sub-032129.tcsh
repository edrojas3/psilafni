...
set output_dir = /misc/tezca/reduardo/data/site-ucdavis/align_tests/${subj}/${subj}_maxscl-1.01
...
@snapshot_volreg ${base_min} ${subj}_anat_nsu_al+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_crA+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_crM+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_crU+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_hel+orig
@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_ls+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lpa+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lpa++orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lpa+ZZ+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lpc+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lpc++orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lpc+ZZ+orig
@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_mi+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_sp+orig
@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_je+orig
#@snapshot_volreg ${base_min} ${subj}_anat_nsu_al_lss+orig
@snapshot_volreg ${base_min} ${subj}_anat_nsu+orig
