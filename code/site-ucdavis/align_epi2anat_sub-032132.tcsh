...
set output_dir = /misc/tezca/reduardo/data/site-ucdavis/align_tests/${subj}/${subj}_epiUnif
...
3dTcat -prefix $output_dir/blip_forward \
    /misc/hahn2/alfonso/primates/monkeys/data/site-ucdavis/${subj}/ses-001/func/${subj}_ses-001_task-resting_run-1_bold.nii.gz
# copy external -blip_reverse_dset dataset
3dTcat -prefix $output_dir/blip_reverse \
    /misc/hahn2/alfonso/primates/monkeys/data/site-ucdavis/${subj}/ses-001/func/${subj}_ses-001_task-resting_acq-RevPol_run-1_bold.nii.gz
