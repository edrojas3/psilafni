...
set subj = sub-032128 # sub-id
set vr_base = /misc/tezca/reduardo/data/site-ucdavis/align_tests/${subj}/${subj}_01/vr_base_min_outlier+orig.BRIK# add path to base func data if you have one 

# assign source and output directory names
set sourcedir = /misc/hahn2/alfonso/primates/monkeys/data/site-ucdavis
set output_dir = /misc/tezca/reduardo/data/site-ucdavis/align_tests/${subj}/${subj}_03
