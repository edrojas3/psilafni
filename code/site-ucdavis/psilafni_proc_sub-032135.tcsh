...
set site      = /misc/tezca/reduardo/data/site-ucdavis # location of dataset
set data_aw   = $site/data_aw/$sub # @animal_warper output directory
set refdir    = /misc/tezca/reduardo/resources/atlases_and_templates/NMT_v2.1_sym/NMT_v2.1_sym_05mm # location of standard template
