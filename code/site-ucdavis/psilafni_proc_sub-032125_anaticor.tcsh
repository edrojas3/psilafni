...
# SET VARIABLES
set subj      = sub-032125 
set outdir    = /misc/tezca/reduardo/data/site-ucdavis/data_ap/sub-032125_anaticor
set cost_func = nmi

# IMPORTANT DIRECTORIES
set site      = /misc/hahn2/alfonso/primates/monkeys/data/site-ucdavis # location of dataset
set data_aw   = /misc/tezca/reduardo/data/site-ucdavis/data_aw/$subj # @animal_warper output directory
...
set WM_Mask   = ${data_aw}/WM_in_${subj}_anat.nii.gz
set CSF_Mask  = ${data_aw}/CSF_in_${subj}_anat.nii.gz
...
afni_proc.py																		\
	...
	-tlrc_NL_warped_dsets                                                    	  	\
						      ${data_aw}/${subj}*_warp2std_nsu.nii.gz         	  	\
	    				      ${data_aw}/${subj}*_composite_linear_to_template.1D 	\
	    				      ${data_aw}/${subj}*_shft_WARP.nii.gz                	\
