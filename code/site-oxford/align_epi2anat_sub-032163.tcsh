...
set output_dir = /misc/tezca/reduardo/data/site-oxford/align_tests/${subj}_SS
...
# ============================ auto block: tcat ============================
		...
		3dTcat -prefix $output_dir/pb00.${subj}.r01.tcat                   \
		    $sourcedir/${subj}/ses-001/func/${subj}_ses-001_task-resting_run-1_bold_SS.nii.gz'[0..199]'
