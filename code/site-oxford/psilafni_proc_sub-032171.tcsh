...
set site      = /misc/tezca/reduardo/data/site-oxford # location of dataset
set data_aw   = $site/data_aw/$subj # @animal_warper output directory
set refdir    = /misc/tezca/reduardo/resources/atlases_and_templates/NMT_v2.0_sym/NMT_v2.0_sym_05mm # location of standard template
