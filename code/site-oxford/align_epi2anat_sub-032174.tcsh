...
set subj = sub-032174  # 2ub-id
set align_centers = 1 # use epi aligned to center of anatomical skull-stripped data
set unifize = 1
...
if ( $align_centers == 1 ) then

	3dTcat -prefix $output_dir/pb00.${subj}.r01.tcat                   \
    	$sourcedir/${subj}/ses-001/func/${subj}_ses-001_task-resting_run-1_bold_ac+orig'[0..1599(2)]'
